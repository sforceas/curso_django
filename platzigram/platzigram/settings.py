...
SECRET_KEY = '6(ir)wz64$xkmrm)f+a8ovqgefe#1a9rnldu3^lb3kcgx#_d*z'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True, # permite encontrar los archivos html dentro de los directorios templates de las diferentes apps
        'OPTIONS': {
            'context_processors': [
