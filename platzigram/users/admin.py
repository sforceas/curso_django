...
class ProfileAdmin(admin.ModelAdmin):
    """Profile admin"""
    list_display = ('pk','user','phone_number','website','picture') # Campos que debe mostrar en el display de admin
    list_display_links=('pk','user') # Elementos linkados al detalle
    list_editable=('phone_number','picture') # Elementos editables desde admin
